...
@SpringBootApplication(scanBasePackages = {
  ...
  DocumentApplication.CLEANUP_MODULE_NAME,
...
@PropertySource("classpath:documents-cleanup.properties")
public class DocumentApplication extends PortalApplicationContextInitializer {
  ...
  public static final String CLEANUP_MODULE_NAME = "org.exoplatform.document.cleanup";
