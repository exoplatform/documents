...
@Component
public class VersionControlWebDavHandler extends WebDavHttpMethodPlugin {

  public VersionControlWebDavHandler() {
  ...
  public void handle(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws WebDavException {
    documentWebDavService.enableVersioning(getResourcePath(httpRequest),
